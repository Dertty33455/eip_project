          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className={`p-4 border-2 rounded-xl flex flex-col items-center gap-2 transition-colors ${provider === 'MTN_MOMO'
              ...
              <button
                ...
                className={`p-4 border-2 rounded-xl flex flex-col items-center gap-2 transition-colors ${provider === 'MOOV_MONEY'
                    ? 'border-primary bg-primary/5'
                    : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
